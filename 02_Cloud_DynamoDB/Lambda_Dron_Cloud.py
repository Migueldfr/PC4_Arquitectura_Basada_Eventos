...
TABLE_NAME = os.environ.get('TABLE_NAME', 'dron_events')
ALARMAS_TABLE = os.environ.get('ALARMAS_TABLE', 'weather_alarmas')
ALLOWED_EVENTS = os.environ.get('ALLOWED_EVENTS', 'wind-sensor,visibility-sensor').split(',')
CONSUMIDOR = os.environ.get('CONSUMIDOR', 'Dron')
